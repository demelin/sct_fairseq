...
def _score_sequence(src_sent, tgt_sent):
    ...
    src_sent_bpe, src_sent_ids = segment_seq(src_sent, src_mt, src_bpe_model, model.encoder.dictionary)
    tgt_sent_bpe, tgt_sent_ids = segment_seq(tgt_sent, tgt_mt, tgt_bpe_model, model.decoder.dictionary)
