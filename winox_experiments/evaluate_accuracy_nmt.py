...
from eval_util import \
    read_jsonl, get_final_index, count_distance_in_subwords, make_bar_plot, make_density_plot
...
def compute_accuracy(samples_path, scores_path, labels_path, codes_path, tgt_lang):
    ...
    print(mwu(x, y, alternative='two-sided'))
    ...
    print(mwu(perplexity_changes_trigger['same_choice'], perplexity_changes_trigger['both_right'],
              alternative='two-sided'))
    print('MWU: same_choice - both_wrong')
    print(mwu(perplexity_changes_trigger['same_choice'], perplexity_changes_trigger['both_wrong'],
              alternative='two-sided'))
    print('MWU: both_right - both_wrong')
    print(mwu(perplexity_changes_trigger['both_right'], perplexity_changes_trigger['both_wrong'],
              alternative='two-sided'))
    # Plot
    ...
    print(mwu(perplexity_changes_pronoun['correct'], perplexity_changes_pronoun['incorrect'],
              alternative='two-sided'))
    # Plot
